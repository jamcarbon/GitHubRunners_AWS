...
def main(argv):
   ...
   print("There is currently 1 Kubernetes group active: ", myautoscalinggroup, "\n")
   currentdesiredcapacity = autoscalegroups['DesiredCapacity']

   print("There are currently ", currentdesiredcapacity, " instances schedule to start and/or running:", "\n")
